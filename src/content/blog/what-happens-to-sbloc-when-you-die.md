---
title: "What Happens to an SBLOC When You Die?"
description: "Securities-backed lines of credit are a cornerstone of the Buy, Borrow, Die strategy — but what actually happens to the loan balance at death? We explain stepped-up basis, estate settlement, and what your heirs face."
pubDate: 2026-07-01
...
This is the cornerstone of the entire "buy, borrow, die" strategy. You borrowed against the asset during your lifetime (no taxable event), and when you die, the basis steps up so the embedded gain is never taxed. The loan gets repaid, the heirs get the assets with a clean basis, and no capital gains tax is ever paid on the appreciation.
...
- Securities portfolio value: **$2,000,000**
- Outstanding SBLOC balance: **$500,000**
- Original cost basis: **$300,000**
- Embedded capital gain: **$1,700,000**

**What your heirs receive:** The securities ($2,000,000) minus the SBLOC balance ($500,000) = **$1,500,000** net. Their cost basis is stepped up to $2,000,000 — the fair market value at death.
...
The SBLOC doesn't vanish when you die. It's a contractual obligation, and someone has to deal with it.
...
The key point: **the loan is repaid from the estate's assets, not from the heirs' personal funds.** Heirs are not personally liable unless they co-signed or personally guaranteed the SBLOC.

---

## This isn't automatic or risk-free
...
## Model the numbers for your own situation

The mechanics of step-up in basis and SBLOC repayment are straightforward. The numbers — your portfolio value, your loan balance, your embedded gain, your estate size — are specific to you.

Our [Buy, Borrow, Die Calculator](/buy-borrow-die-calculator/) lets you:

- **Model your net inheritance** after SBLOC repayment under different portfolio values and loan balances
- **See the tax savings** from step-up in basis compared to a lifetime sale
- **Estimate your estate's exposure** to different scenarios
